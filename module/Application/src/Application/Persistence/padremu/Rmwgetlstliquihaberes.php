...
use Application\Persistence\padremu\RmwgetlstliquihaberesRs;    
use Application\Persistence\padremu\RmwgetlstliquihaberesOut; 
// core.
...
class Rmwgetlstliquihaberes {
    ...
    public function execute($in) {
        ...
        $this->plsql->setName('Rmw_get_lst_liqui_haberes');
	...
	$this->plsql->setFunction(true);
        ...
        if ($result) {
            ...
            $out = new RmwgetlstliquihaberesOut();
    ...
    private function mapRs($array) {
        ...
        foreach ($array as $key => $v) {
            ...
            $rs = new RmwgetlstliquihaberesRs();
