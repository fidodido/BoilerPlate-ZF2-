...
use Application\Persistence\padremu\RmwgetlstcumpleanosRs;    
use Application\Persistence\padremu\RmwgetlstcumpleanosOut; 
// core.
...
class Rmwgetlstcumpleanos {
    ...
    public function execute($in) {
        ...
        $this->plsql->setName('Rmw_get_lst_cumpleanos');
	...
	$this->plsql->setFunction(true);
        ...
        if ($result) {
            ...
            $out = new RmwgetlstcumpleanosOut();
    ...
    private function mapRs($array) {
        ...
        foreach ($array as $key => $v) {
            ...
            if (isset($v[strtoupper('trab_fecnac_fmt')])) {
                $rs->setTrab_fecnac_fmt($v[strtoupper('trab_fecnac_fmt')]);
            }
            $rsList[] = $rs;
        }
