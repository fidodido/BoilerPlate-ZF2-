...
use Application\Persistence\padremu\RmwgetlsttrabajadorRs;    
use Application\Persistence\padremu\RmwgetlsttrabajadorOut; 
// core.
...
class Rmwgetlsttrabajador {
    ...
    public function execute($in) {
        ...
        $this->plsql->setName('Rmw_get_lst_trabajador');
	...
	$this->plsql->setFunction(true);
        ...
        if ($result) {
            ...
            $out = new RmwgetlsttrabajadorOut();
